...
# 	sed -e '/^MODULE_VERSION/s/5\.15\.[3456789]/$(QT5_SINGLE_VERSION)/' -i \
...
# $(2)_POST_PREPARE_HOOKS += QT5_SINGLE_QT_CONF_FIXUP
...
define $(2)_CONFIGURE_CMDS
	cd $$($(2)_BUILDDIR) && \
	$$(TARGET_MAKE_ENV) $$($(2)_CONF_ENV) $$(QT5_SINGLE_QMAKE) $$($(2)_CONF_OPTS)
endef
endif
...
################################################################################
# qmake-custom-package -- the target generator macro for QMake packages
################################################################################

qmake-single-package = $(call inner-qmake-single-package,$(pkgname),$(call UPPERCASE,$(pkgname)),$(call UPPERCASE,$(pkgname)),target)
